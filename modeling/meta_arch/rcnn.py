...
#-------------------------------------------------------------------------------------------------add
#from lib.det_opr.fpn_roi_target import fpn_roi_target
#-------------------------------------------------------------------------------------------------add
...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        features = self.backbone(images.tensor)  #fpn提取特征
        ...
        if isinstance(self.proposal_generator, RBG):
            ...
            gt_boxes, proposals, proposal_losses = self.proposal_generator(
                images, features, gt_instances
            )
            
            # print('gt_boxes......',len(gt_boxes))
            # print('proposals......',proposals.size())
            # print('proposal_losses......',len(proposal_losses))
        else:
            ...
            proposal_losses = {}
#-----------------------------------------------------------------------------------------------------add
        # rcnn_rois, rcnn_labels, rcnn_bbox_targets = fpn_roi_target(self.cfg, 
        #     features, images, gt_boxes, top_k=2)
#-----------------------------------------------------------------------------------------------------add        
        _, detector_losses = self.roi_heads(
            images, features, proposals, gt_instances
        )
        # print('detector_losses...', detector_losses[0], detector_losses[1])
        losses = {}
