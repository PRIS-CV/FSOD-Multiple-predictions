...
# python -m tools.train_net \
#     --config-file configs/COCO-detection/faster_rcnn_R_50_FPN_ft_novel_10shot_l2.yaml \
#     --num-gpus 4
...
#     --coco \
#     --src1 /backup/guanmandan/checkpoints/coco/faster_rcnn/base_loss2/model_final.pth \
#     --src2 /backup/guanmandan/checkpoints/coco/faster_rcnn/faster_rcnn_R_50_FPN_ft_novel_10shot_l2/model_final.pth \
#     --save-dir /backup/guanmandan/checkpoints/coco/faster_rcnn/faster_rcnn_R_50_FPN_ft_novel_10shot_l2

python -m tools.train_net \
    --config-file configs/COCO-detection/l2_faster_rcnn_R_50_FPN_ft_all_10shot_aug_ftmore_dropout.yaml \
    --num-gpus 4 \
    --resume
